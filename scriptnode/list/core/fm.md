...
- FreqMultiplier: a pitch multiplier. You can use it to create different harmonics or connect it to a [`core.hise_mod`](/scriptnode/list/core/hise_mod.html) node for pitch modulation.
---
...
The node is producing a sine wave as output and if you want to create custom waveforms, please use the [phasor_fm](/scriptnode/list/core/phasor_fm.html) node as generator of the base waveform.
